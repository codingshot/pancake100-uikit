...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#000000", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#666171", tertiary: "#EFF4F5", text: "#00CC9B", textDisabled: "#BDC2C4", textSubtle: "#018D6C", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#00EDB4", background: "#222222", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#00CC9B", inputSecondary: "#66578D", primaryDark: "#018D6C", tertiary: "#2F2F2F", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#00CC9B", borderColor: "#00CC9B", card: "#000000", gradients: {
...
var InfoTooltip = function (_a) {
    ...
    var _b = useTooltip(text, {}), targetRef = _b.targetRef, tooltip = _b.tooltip, tooltipVisible = _b.tooltipVisible;
    return (React__default['default'].createElement(Flex, __assign({}, props, { alignItems: "center" }),
        ...
        React__default['default'].createElement(Flex, { ref: targetRef, alignItems: "center" },
            React__default['default'].createElement(IconComponent, { iconName: "Info", color: "textSubtle" }))));
};
...
var getTextColor$1 = function (eventStatus) {
...
var Timeline = function (_a) {
    ...
    return (React__default['default'].createElement(TimelineContainer, null, events.map(function (_a) {
        ...
        return (React__default['default'].createElement(TimelineEvent, { key: text },
            React__default['default'].createElement(Flex, { mr: "10px", alignItems: "center" },
                isUpcoming && React__default['default'].createElement(IconComponent, { iconName: "CircleOutline", color: "textDisabled" }),
                isLive && React__default['default'].createElement(IconComponent, { iconName: "Logo" }),
                isPast && React__default['default'].createElement(IconComponent, { iconName: "CheckmarkCircleFill", color: "textSubtle" })),
            React__default['default'].createElement(Text, { color: getTextColor$1(status), bold: true }, text),
            altText && (React__default['default'].createElement(Text, { color: "warning", ml: "2px", bold: true }, altText)),
            infoText && React__default['default'].createElement(InfoTooltip, { text: infoText, ml: "10px" })));
    })));
};
...
var DropdownMenu = function (_a) {
    ...
    return (React__default['default'].createElement(Box, __assign({ ref: isBottomNav ? null : setTargetRef }, props),
        ...
        isBottomNav && isOpen && React__default['default'].createElement(StyledOverlay, null),
